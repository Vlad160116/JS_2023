...
for (let i = 0; i < 10; i++) {
  document.write(`<div>Glory to Ukraine </div>`);
}

// - За допомогою циклу for і document.write() вивести 10 блоків div c довільним текстом і індексом всередині

for (let i = 0; i < 10; i++) {
  document.write(`<ol><div> ${i} We support Ukraine </div></ol>`);
}
...
let i = 0;
while (i < 20) {
  document.write(`<ol><h1> ${i} Hello Okten</h1></ol>`);
  i++;
}
...
for (const product of products) {
  document.write(`<h3>${product.title} ${product.price}</h3> ${product.image}`);
}
document.write('</div>');
