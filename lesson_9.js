...
block.innerText = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum tempore architecto asperiores incidunt voluptatem quae.'
...
blockClone.innerText = 'Bla bla bla';
blockClone.style.background = 'yellow';
blockClone.style.color = 'red';
...
for (const simps of simpsons) {
    ...
    // div.classList.add('member')
    a.innerText = simps.name;
    b.innerText = simps.surname;
    c.innerText = simps.age;
    d.innerText = simps.info;
    image.setAttribute('src', simps.photo);

    div.append(a,b,c,d,image);
    document.body.appendChild(div);
}
...
for (const course of coursesArray) {
    ...
    let modules = document.createElement('modules');
    let ul = document.createElement('ul');
    ...
    header.append(title,month,hour, modules);
